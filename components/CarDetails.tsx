    ...
    <>
        <Transition appear show={isOpen} as={Fragment}>
            <Dialog as="div" className="relative z-10" 
                    onClose={closeModal}>
                <Transition.Child //!create a page switch to transition to the details
                    as={Fragment}
                ...
                <div className="fixed inset-0 overflow-y-auto">
                   ...
                   overflow-x-hidden overflow-y-hidden transform rounded-2xl p-6 bg-white text-left
                        ...
                        <button //? Adding the close Button
                            ...
                            bg-primary-blue-100 rounded-sm"
                            onClick={closeModal}
                        >
                            <Image 
                            src="/close.svg"
                        ...
                        <div className="flex-1 flex flex-col gap-3">
                            ...
                            <div className="flex gap-4 bg-primary-blue content-center">

                                <div className="flex-1 relative  w-full h-24 bg-primary-blue">
                                <Image src={generateCarImageUrl(car, '25')} 
                                alt="car_model" fill priority className="
                                object-contain"/>
                                </div>
                                
                                <div className="flex-1 relative w-full h-24 bg-primary-blue">
                                <Image src={generateCarImageUrl(car, '30')} 
                                alt="car_model" fill priority className="
                                object-contain"/>
                                </div>
                                
                                <div className="flex-1 relative w-full h-24 bg-primary-blue">
                                <Image src={generateCarImageUrl(car, '12')} 
                                alt="car_model" fill priority className="
                                object-contain"/>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 flex flex-col gap-2">
                                <h2 className="font-semibold text-xl capitalize gap-3 text-center">
                                    {car.make} {car.model}
                                </h2>

                            <div className="mt-4 flex flex-col p-10 gap-4">
